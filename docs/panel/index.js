...
var examples = {
  ...
  header: require('fs').readFileSync(__dirname + '/02-header.js', 'utf-8'),
  footer: require('fs').readFileSync(__dirname + '/03-footer.js', 'utf-8'),
  style: require('fs').readFileSync(__dirname + '/04-style.js', 'utf-8'),
  table: require('fs').readFileSync(__dirname + '/05-table.js', 'utf-8'),
  list: require('fs').readFileSync(__dirname + '/06-list.js', 'utf-8'),
  group: require('fs').readFileSync(__dirname + '/07-group.js', 'utf-8'),
  collapsible: require('fs').readFileSync(__dirname + '/08-collapsible.js', 'utf-8'),
  cg: require('fs').readFileSync(__dirname + '/09-controlled-group.js', 'utf-8'),
