...
var examples = {
  ...
  bordered: require('fs').readFileSync(__dirname + '/02-bordered.js', 'utf-8'),
  compact: require('fs').readFileSync(__dirname + '/03-compact.js', 'utf-8'),
  responsive: require('fs').readFileSync(__dirname + '/04-responsive.js', 'utf-8'),
